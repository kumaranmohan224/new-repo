...
public class SpainPhysicalCheckOutUsingExistingUser extends ScriptBase {
	...
	public void IntructorArea(String ParameterNValue, String env) throws Exception {
		try {
			...
			String strDescription = "Launch the Spain URL in browser for SpainPhysicalCheckOutUsingExistingUser";
