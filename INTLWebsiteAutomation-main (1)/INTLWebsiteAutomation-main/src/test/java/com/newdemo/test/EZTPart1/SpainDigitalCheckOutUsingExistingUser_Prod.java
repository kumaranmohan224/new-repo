...
public class SpainDigitalCheckOutUsingExistingUser_Prod extends ScriptBase {
	...
	public void IntructorArea(String ParameterNValue, String env) throws Exception {
		try {
			...
			String strDescription = "Launch the Spain URL in browser for SpainDigitalCheckOutUsingExistingUser_Prod";
	...
	public void loginLATAMURL() throws Exception {
		...
		driver.get("https://www.mheducation.es/blog");
