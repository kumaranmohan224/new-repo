...
public class ColPhysicalCheckOutUsingExistingUser extends ScriptBase {
	...
	public void IntructorArea(String ParameterNValue, String env) throws Exception {
		try {
			...
			String strDescription = "Launch the Colombia URL in browser for ColPhysicalCheckOutUsingExistingUser";
	...
	public void loginLATAMURL() throws Exception {
		...
		connect().INTLLoginPage().clickActionPrintPrimaryToCartCol();
