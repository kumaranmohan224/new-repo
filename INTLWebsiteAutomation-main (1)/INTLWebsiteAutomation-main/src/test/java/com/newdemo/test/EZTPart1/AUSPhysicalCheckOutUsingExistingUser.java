...
public class AUSPhysicalCheckOutUsingExistingUser extends ScriptBase {
	...
	public void IntructorArea(String ParameterNValue, String env) throws Exception {
		try {
			...
			String strDescription = "Launch the Australia URL in browser for AUSPhysicalCheckOutUsingExistingUser";
