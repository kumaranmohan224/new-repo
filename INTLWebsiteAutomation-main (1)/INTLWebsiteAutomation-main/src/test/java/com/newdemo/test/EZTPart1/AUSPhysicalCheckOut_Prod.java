...
public class AUSPhysicalCheckOut_Prod extends ScriptBase {
	...
	public void IntructorArea(String ParameterNValue, String env) throws Exception {
		try {
			...
			String strDescription = "Launch the Australia URL in browser for AUSPhysicalCheckOut_Prod";
	...
	public void loginLATAMURL() throws Exception {
		...
		connect().INTLLoginPage().selectShippingAddressRegionIdValueAustralia();
