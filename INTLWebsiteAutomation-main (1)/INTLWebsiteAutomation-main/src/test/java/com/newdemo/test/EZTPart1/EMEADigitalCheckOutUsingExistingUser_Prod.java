...
public class EMEADigitalCheckOutUsingExistingUser_Prod extends ScriptBase {
	...
	public void IntructorArea(String ParameterNValue, String env) throws Exception {
		try {
			...
			String strDescription = "Launch the EMEA URL in browser for EMEADigitalCheckOutUsingExistingUser_Prod";
