...
public class ASIADigitalCheckOutUsingExistingUser_Prod extends ScriptBase {
	...
	public void IntructorArea(String ParameterNValue, String env) throws Exception {
		try {
			...
			String strDescription = "Launch the Asia URL in browser for ASIADigitalCheckOutUsingExistingUser_Prod";
