...
public class ProfessionalPhysicalCheckOut_Prod extends ScriptBase {
	...
	public void IntructorArea(String ParameterNValue, String env) throws Exception {
		try {
			...
			String strDescription = "Launch the Professional URL in browser for ProfessionalPhysicalCheckOut_Prod";
	...
	public void loginLATAMURL() throws Exception {
		...
		connect().INTLLoginPage().selectShippingAddressRegionIdValueProfessional();
