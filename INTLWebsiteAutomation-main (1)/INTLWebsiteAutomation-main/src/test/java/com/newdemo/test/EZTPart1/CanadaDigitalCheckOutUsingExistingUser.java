...
public class CanadaDigitalCheckOutUsingExistingUser extends ScriptBase {
	...
	public void IntructorArea(String ParameterNValue, String env) throws Exception {
		try {
			...
			String strDescription = "Launch the Canada URL in browser for CanadaDigitalCheckOutUsingExistingUser";
