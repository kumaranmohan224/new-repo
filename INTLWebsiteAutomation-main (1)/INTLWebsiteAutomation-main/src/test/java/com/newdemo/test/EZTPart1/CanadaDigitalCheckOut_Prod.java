...
public class CanadaDigitalCheckOut_Prod extends ScriptBase {
	...
	public void IntructorArea(String ParameterNValue, String env) throws Exception {
		try {
			...
			String strDescription = "Launch the Canada URL in browser for CanadaDigitalCheckOut_Prod";
	...
	public void loginLATAMURL() throws Exception {
		 ...
		 * connect().INTLLoginPage().clickActionPrintPrimaryToCartCanada();
		 * connect().INTLLoginPage().clickAcceptAllButton();
		 */
