...
public class ExcelSim extends ScriptBase {
	...
	public void CreateCourse(String ParameterNValue) throws Exception
	{
		try {
			...
			final int ExcelSimAsignment = 8;
			final int ExcelSimCourse = 5;
			...
			//add Course
			this.strDTParametersNValues="InputDataRow=>"+ExcelSimCourse;
			addCourse();
			
			// Create Assignment with Policy
			this.strDTParametersNValues="InputDataRow=>"+ExcelSimAsignment;
			createAssignment(ExcelSimAsignment);
