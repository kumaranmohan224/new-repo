...
public class LATAMPhysicalCheckOutUsingExistingUser extends ScriptBase {
	...
	public void IntructorArea(String ParameterNValue, String env) throws Exception {
		try {
			...
			String strDescription = "Launch the LATAM URL in browser for LATAMPhysicalCheckOutUsingExistingUser";
