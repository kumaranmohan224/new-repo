...
public class ColDigitalCheckOutUsingExistingUser_Prod extends ScriptBase {
	...
	public void IntructorArea(String ParameterNValue, String env) throws Exception {
		try {
			...
			String strDescription = "Launch the Colombia URL in browser for ColDigitalCheckOutUsingExistingUser_Prod";
