...
public class EMEAPhysicalCheckOutUsingExistingUser extends ScriptBase {
	...
	public void IntructorArea(String ParameterNValue, String env) throws Exception {
		try {
			...
			String strDescription = "Launch the EMEA URL in browser for EMEAPhysicalCheckOutUsingExistingUser";
	...
	public void loginLATAMURL() throws Exception {
		...
		connect().INTLLoginPage().clickActionPrintToCartEMEA();
		connect().INTLLoginPage().clickAcceptAllButton();
		connect().INTLLoginPage().clickActionShowCartButton();
