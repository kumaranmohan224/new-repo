...
public class CanadaPhysicalCheckOut extends ScriptBase {
	...
	public void IntructorArea(String ParameterNValue, String env) throws Exception {
		try {
			...
			String strDescription = "Launch the Canada URL in browser for CanadaPhysicalCheckOut";
	...
	public void loginLATAMURL() throws Exception {
		...
		connect().INTLLoginPage().clickActionPrintPrimaryToCartPhysicalCheckOutCanada();
		connect().INTLLoginPage().clickAcceptAllButton();
