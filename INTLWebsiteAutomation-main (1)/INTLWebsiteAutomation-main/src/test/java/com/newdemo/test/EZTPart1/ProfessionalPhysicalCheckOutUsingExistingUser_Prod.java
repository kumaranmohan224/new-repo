...
public class ProfessionalPhysicalCheckOutUsingExistingUser_Prod extends ScriptBase {
	...
	public void IntructorArea(String ParameterNValue, String env) throws Exception {
		try {
			...
			String strDescription = "Launch the Professional URL in browser for ProfessionalPhysicalCheckOutUsingExistingUser_Prod";
